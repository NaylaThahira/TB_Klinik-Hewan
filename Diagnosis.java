...
public class Diagnosis {
    ...
    private LocalDate tanggalDiagnosis; // Menambahkan atribut tanggal diagnosis
    ...
    public LocalDate getTanggalDiagnosis() {
    ...
    public String toString() {
        ...
        return "Hewan: " + namaHewan + ", Penyakit: " + penyakit  +
               ", Obat: " + namaObat + ", Dosis: " + dosis + "mg" + ", Dokter: " + namaDokter + ", Tanggal Diagnosis: " + tanggalDiagnosis;
    }
}
